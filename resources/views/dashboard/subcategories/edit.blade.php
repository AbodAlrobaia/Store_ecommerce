                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                            action="{{ route('admin.subcategory.update', $category->id) }}"
                                                                ...
                                                                <optgroup label="من فضلك أختر القسم ">
                                                                    @if ($categories && $categories->count() > 0)
                                                                        @foreach ($categories as $maincategory)
                                                                            <option value="{{   $maincategory->id }}" @if($maincategory->id == $category->parent_id) selected @endif>
                                                                                {{ $maincategory->name }}
                                                                            </option>
                                                                        @endforeach
                                                                    @endif
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            <input type="checkbox" value="1" name="is_active"
                                                                ...
                                                                data-color="success" @if ($category->is_active == 1)checked @endif />
