                                        ...
                                        <form class="form" action="{{ route('update.profile')}}" method="post" enctype="multipart/form-data">
                                            ...
                                            <input type="hidden" name="id" value="{{ $admin->id }}">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$admin->name }}" id="" class="form-control"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">   تاكيد كلمة المرور الجديده </label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">   تاكيد كلمة المرور الجديده </label>
                                                            <input type="password" value="" id=""
                                                                class="form-control" placeholder="  " name="password-confirmation">
                                                            {{-- @error('password')
                                                                <span class="text-danger">{{ $message }}</span>
                                                            @enderror --}}
                                                        {{-- </div>
